...
{% renderFile '../_includes/example-preissuance-credential.html' %}
...
{% renderFile '../_includes/example-issued-credential.html' %}
...
{% renderFile '../_includes/example-verifiable-presentation.html' %}
